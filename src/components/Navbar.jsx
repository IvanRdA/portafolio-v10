...
export default function Navbar(props) {
  ...
  return (
    <div
      className={`grid grid-flow-row auto-cols-max col-span-3 md:flex md:flex-col justify-center items-center p-2 w-[80%] h-[100%] md:h-[10vh] mb-2 font-ojuju text-xl`}
    >
      <div className="flex flex-col md:flex-row justify-center items-center w-[100%]">
        ...
        <ul
          className={`md:flex grid grid-flow-row grid-cols-3 col-span-3 md:flex-row justify-between items-center gap-10`}
        >
          <li
            onClick={(e) => {
              handler(1);
